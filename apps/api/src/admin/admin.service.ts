    ...
    return {
      ...
      teams: teams.map((team) => ({
        ...
        players: team.players.map((playerRow) => ({
          ...
          firstNames: playerRow.player.firstNames,
          lastNames: playerRow.player.lastNames,
  ...
  async listTournamentPlayers(tournamentId: string) {
      ...
      select: {
        ...
        players: {
          ...
          select: {
            ...
            position: true,
            shirtNumber: true,
            player: { select: { fullName: true, shortName: true, firstNames: true, lastNames: true } },
          },
        },
      },
    ...
    return teams.flatMap((team) =>
      team.players.map((p) => ({
        ...
        firstNames: p.player.firstNames,
        lastNames: p.player.lastNames,
