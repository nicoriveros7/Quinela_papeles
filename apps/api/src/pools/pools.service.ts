          ...
          return {
            ...
            player: base
              ? {
                  ...
                  firstNames: base.firstNames,
                  lastNames: base.lastNames,
    ...
    const [prediction, tournament, tournamentTeams, tournamentPlayers] = await Promise.all([
      this.prisma.tournamentPrediction.findUnique({
        ...
        include: {
          ...
          topScorer: { include: { player: { select: { id: true, fullName: true, shortName: true, nameOnShirt: true, firstNames: true, lastNames: true, nationalityCode: true } } } },
          goldenBall: { include: { player: { select: { id: true, fullName: true, shortName: true, nameOnShirt: true, firstNames: true, lastNames: true, nationalityCode: true } } } },
          goldenGlove: { include: { player: { select: { id: true, fullName: true, shortName: true, nameOnShirt: true, firstNames: true, lastNames: true, nationalityCode: true } } } },
        },
      }),
      ...
      this.prisma.tournamentPlayer.findMany({
        ...
        select: {
          id: true,
          isGoalkeeper: true,
          player: { select: { id: true, fullName: true, shortName: true, nameOnShirt: true, firstNames: true, lastNames: true, nationalityCode: true } },
        },
